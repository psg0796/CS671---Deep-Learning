...
output_color = tf.keras.layers.Dense(10, activation='softmax', name='output_color')(tf.keras.layers.Dropout(0.2)(tf.keras.layers.Dense(128, activation='elu')(tf.keras.layers.Flatten()(feature_map))))
output_angle = tf.keras.layers.Dense(10, activation='softmax', name='output_angle')(tf.keras.layers.Dropout(0.2)(tf.keras.layers.Dense(128, activation='elu')(tf.keras.layers.Flatten()(feature_map))))
